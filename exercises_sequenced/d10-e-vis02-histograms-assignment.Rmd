...
- Which graph---`vis1` or `vis2`---best helps you answer each question?
  - vis1 for the first and vis2 for the second.
...
**Observations** - The trend that there are higher counts on the round decimals is evident throughout higher resolutions until you hit about 0.1 carat bin width.
