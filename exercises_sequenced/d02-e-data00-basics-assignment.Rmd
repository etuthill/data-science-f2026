...
color: color ranking (J-D)

clarity: how clear diamond is (I1-IF)
...
- The common values are listed under each variable. The value based ones
  can be calculated from max - min.
