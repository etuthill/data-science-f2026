...
colwise                Column-wise operations (source, html) base                   dplyr <-> base R (source, html) 
grouping               Grouped data (source, html) 
dplyr                  Introduction to dplyr (source, html) programming            Programming with dplyr (source, html) recoding-replacing     Recoding columns and replacing values                        (source, html) 
rowwise                Row-wise operations (source, html) 
two-table              Two-table verbs (source, html) 
in-packages            Using dplyr in packages (source, html) window-functions       Window functions (source, html)
```
