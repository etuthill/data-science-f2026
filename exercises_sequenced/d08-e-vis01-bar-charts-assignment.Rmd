...
**Observations**: - Dodge adds more columns which means that some of the bars are getting stacked. The data makes more sense with the dodge because there's a clear upward trend that you would expect from the comparison.
...
**Observations**: - This gives the count of different classes.
...
**Observations**: - This gives the count of different classes with breakdown by drive train type.

**Compare `v1` and `v2`**:

- Which visualization---`v1` or `v2`---enabled you to make more observations?
- There's straight up more information on the second version. The second communicates the same information as the first, with the count of different classes, but the second also gives you a breakdown of the drive train types within each class on top of the other communicated info.
- What was the difference between `v1` and `v2`?
- The addition of drive train type within the classes.
...
**Observations** - There's a lot of variety. It's kind of hard to read with the doding.
