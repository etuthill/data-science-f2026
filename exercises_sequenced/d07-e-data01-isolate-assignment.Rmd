...
df_q3 <- 
  flights %>% 
    filter(between((sched_arr_time-arr_time), -10, 10), 
         sched_arr_time != arr_time
    )
...
**Observations** - Was this dataset assembled to study flights *out of* NYC, or *into* NYC? How do you know? - Departed because it says it in the ?flights data description.
