...
**Observations**: - No. The graph shows that Ideal are the most
numerous.
...
**Observations**: - It doesn't relate to hypothesis 2 because there's no
way to see how many of different cuts there are.
...
**Observations**: - It still isn't relevant because there's no way to
determine quantities from this graph.
...
Yes. It could explain why cut doesn't really have that much impact on
price. The price spread of cuts are fairly evenly distributed.
...
**Observations**: - It's not like 100% solid but overall you do see an
increase in quality at lower carats.
