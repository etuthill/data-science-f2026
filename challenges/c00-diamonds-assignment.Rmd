...
- There appears to be a positive correlation between carat and price, though it isn't linear and prices curve upward as carats increase. There is a fair spread of prices for diamonds of the same carat, which suggests there are other factors that help to determine price. There's also especially large bands at 1 carat, 1.5 carats, and 2 carats which suggests that nice numbers like that might be more favored. The lower the carat, the more common as well because the density of data decreases at higher carats.
...
- This appears to demonstrate at least part of the missing puzzle piece from the previous graph. Based on this, it is likely that at least part of the cause for significant price variability within diamonds of the same carat comes from the cut quality. This is because the ideal cuts tend to dominate the higher prices while the fair cuts tend to be lower priced. However, there is still a fair amount of price variability within the range of cuts.
